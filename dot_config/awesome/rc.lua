...
require("custom_widgets/volume")
require("custom_widgets/backlight")
require("custom_widgets/battery")
require("custom_widgets/cpu_usage")
require("custom_widgets/ram_usage")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "1:term", "2:web", "3", "4", "5:tg" }, s, awful.layout.layouts[2])
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, 'l', function() awful.spawn('/home/asp437/.local/bin/screenlock') end,
...
for i = 1, 10 do
    globalkeys = gears.table.join(globalkeys,
        ...
        awful.key({ modkey, "Control", "Shift" }, "#" .. i + 9,
                  ...
                  {description = "toggle focused client on tag #" .. (1 + ((i - 1) % 5)), group = "tag"})
    )
end
