...
theme.bg_urgent     = colours.bg_urgent
theme.bg_minimize   = colours.bg_minimize
theme.bg_systray    = colours.bg_systray

theme.fg_normal     = colours.fg_normal
theme.fg_focus      = colours.fg_focus
theme.fg_urgent     = colours.fg_urgent
...
theme.wallpaper = "/home/asp437/.config/awesome/wallpaper/blade_runner.jpg"
